...
functs_rtype = \
{
    ...
    # added the rest of the R-types below:
    "SUB": ("000", "1", lambda a,b: a-b, lambda a: a, lambda b: b),
    "SLL": ("001", "0", lambda a,b: a<<b, lambda a: a, lambda b: b&0x1f),
    "SLT": ("010", "0", lambda a,b: int(comp(a,b)), lambda a: a, lambda b: b),
    "SLTU": ("011", "0", lambda a,b: int(a < b), lambda a: a, lambda b: b),
    ...
    # finished adding all R-types above ^^^^
}
